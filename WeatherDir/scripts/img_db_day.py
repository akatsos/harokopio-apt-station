...
img_path_hvc = img_date + '_' + img_time + '/' + img_name_hvc + '.png'
...
#HVC
cur.execute("INSERT INTO sat_images (id, pass_id, path, img_name, enhancement) VALUES(%s, %s, %s, %s, %s)", (int(img_id_hvc), int(pass_id), img_path_hvc, img_name_hvc, "HVC"))
